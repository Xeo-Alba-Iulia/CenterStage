...
//        ridicare2.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
    ...
    public double joystick_speed(double x, double y){
        return Math.sqrt(x*x+y*y);
    }
    public double joystick_angle(double x, double y){
        return Math.atan(y/x);
    }

    private double normalizare(double x, double minX, double maxX){
